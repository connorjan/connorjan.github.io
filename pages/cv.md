...
<a href="{{ site.url }}/cv/cv.pdf" class="social-icons" title="Printer friendly format"><i class="fa fa-print"></i></a>
</span>
...
<iframe src="{{ site.url }}/cv/cv.pdf" width="100%" style="height: 100vh;"></iframe>
